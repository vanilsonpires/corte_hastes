...
public class AtividadeGulosoInterativo {
	...
	public static void executar() throws FileNotFoundException {
		...
		ArrayList<Integer> vetorAux1 = new ArrayList<>();// Vetor Auxiliar tempo
															// inicial
		ArrayList<Integer> vetorAux2 = new ArrayList<>();// Vetor Auxiliar tempo
															// final
		...
		int[] vetorI = new int[vetorAux1.size()];// Vetor Principal de tempo
													// inicial
		int[] vetorF = new int[vetorAux2.size()];// Vetor Principal de tempo
													// final

		for (int i = 0; i < vetorAux1.size(); i++) {// Passando Variaveis do
													// vetor auxiliar para vetor
													// principal
